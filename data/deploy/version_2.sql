...
INSERT INTO "movie" ("french_title","original_title","poster_url","directors","release_date","duration","casting","presentation","is_published","publishing_date","user_id","season_id") VALUES

('Les Chaussons Rouges','The Red Shoes','poster_url','{"Michael Powell","Emeric Pressburger"}',1948,125,'{"Moira Shearer","Marius Goring","Anton Walbrook","Robert Helpmann","Albert Bassermann"}',
...
('Stalker', 'Stalker','poster_url', '{"Andrei Tarkovsky"}',1979,162, '{"Alisa Freyndlikh", "Alexandr Kaydanovskiy", "Anatoliy Solonitsyne", "Nikolay Grinko", "Natalya Abramova"}', 
...
('The King''s Choice','Kongens Nei','poster_url','{"Michael Powell","Emeric Pressburger"}',1948,125,'{"Jesper Christensen","Anders Baasmo Christiansen","Karl Markovics","Tuva Novotny","Arthur Hakalahti"}',
...
('New World', 'Sinsegye','poster_url', '{"Park Hoon-jung"}', 2013, 135, '{"Lee Jung-jae", "Choi Min-sik", "Jung-min Hwang", "Park Sung-woong", "Song Ji-Hyo"}', 'Un flic infiltré dans une mafia devient l''ami du sous-boss. Dans un dilemme moral, 
